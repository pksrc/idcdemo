...
//tealium universal tag - utag.sender.6026 ut4.0.202112031354, Copyright 2021 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
...
if(window.location.href.indexOf('vmware.com') > -1){
    var fbqFlag;
var fbqViewContent = function(){
    if(typeof fbq !== "undefined"){
    clearTimeout(fbqFlag);
fbq('track', 'ViewContent');
    //console.log("Test If Block");
}
else{
    //console.log("Test Else Block");
     fbqFlag = setTimeout(function(){ fbqViewContent(); }, 2000);
      ...
      for(c=0;c<u.extend.length;c++){try{d=u.extend[c](a,b);if(d==false)return}catch(e){}};
        ...
        if (u.initialized) {
          ...
          if (!u.scriptrequested) {
            ...
            u.loader({"type": "script",  "src": u.data.base_url, "cb": u.callBack, "loc": "script", "id": 'utag_21'});
            //FB PreLoad Code
            !function (f, b, e) {
